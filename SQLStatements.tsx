...
FOREIGN KEY(WORKOUTS) REFERENCES workouts (ID) ON DELETE CASCADE ON UPDATE CASCADE);`,
  ...
  export const insertExampleWorkout = 
  `INSERT INTO days_to_workouts (DAYS, WORKOUTS) SELECT days.NAME, ID FROM days LEFT JOIN workouts WHERE workouts.NAME == "Power Clean";`
